...
int main()
{
	...
	brickProgramObject->addShader(osg::Shader::readShaderFile(osg::Shader::VERTEX, osgDB::findDataFile("shaders/brick.vert")));
	brickProgramObject->addShader(osg::Shader::readShaderFile(osg::Shader::FRAGMENT, osgDB::findDataFile("shaders/brick.frag")));
